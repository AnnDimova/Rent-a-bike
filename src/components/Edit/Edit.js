...
import { bikeTypes, formFields } from "../../constants/constants";
import {
  checkMaxLength,
  checkMinLength,
  checkUrl,
...
export const Edit = () => {
  ...
  const [selectedType, setSelectedType] = useState(bikeTypes[0]);
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    const bikeData = Object.fromEntries(new FormData(e.target));
    await bikeService.edit(bikeData, bikeId, auth.accessToken);
    await sleep(250);
          ...
          <form onSubmit={onSubmit} ref={formRef}>
              ...
              <div className="col-6">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="image"
                    name="image"
                    defaultValue={currentBike.image}
              ...
              <div className="col-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="capacity"
                    name="capacity"
                    defaultValue={currentBike.capacity}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="location"
                    name="location"
                    defaultValue={currentBike.location}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="price"
                    name="price"
                    defaultValue={currentBike.price}
            ...
            <div className="form-group">
              ...
              <textarea
                id="description"
                name="description"
                defaultValue={currentBike.description}
